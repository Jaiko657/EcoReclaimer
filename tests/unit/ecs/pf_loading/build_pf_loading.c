...
int main(int argc, char **argv)
{
    ...
    if (!nob_mkdir_if_not_exists("build/tests/obj/pf_loading")) return 1;
    if (!nob_mkdir_if_not_exists("build/tests/plugins")) return 1;

    Nob_File_Paths test_sources = {0};
    nob_da_append(&test_sources, "tests/unit/ecs/pf_loading/test_pf_loading.c");

    const char *runner_path = "build/tests/gen/tests_pf_loading_runner.c";
    if (!generate_unity_runner("pf_loading", &test_sources, runner_path)) return 1;
    ...
    nob_da_append(&sources, "src/game/ecs/components/ecs_component_conveyor.c");
    nob_da_append(&sources, "src/game/ecs/components/ecs_component_liftable.c");
    nob_da_append(&sources, "src/game/ecs/components/ecs_component_grav_gun.c");
    nob_da_append(&sources, "src/game/ecs/components/ecs_component_gun_charger.c");
    nob_da_append(&sources, "src/game/ecs/components/ecs_component_unpacker.c");
    nob_da_append(&sources, "src/game/ecs/components/ecs_component_unloader.c");
    nob_da_append(&sources, "src/game/ecs/ecs_game_init.c");
    nob_da_append(&sources, "src/game/ecs/components/ecs_component_resource.c");
    nob_da_append(&sources, "src/game/ecs/systems/ecs_storage.c");
    nob_da_append(&sources, "src/game/ecs/systems/ecs_unloader.c");
    nob_da_append(&sources, "src/game/ecs/systems/ecs_recycler.c");
    nob_da_append(&sources, "src/engine/ecs/ecs_proximity.c");
    nob_da_append(&sources, "src/engine/ecs/ecs_billboards.c");
    nob_da_append(&sources, "src/game/ecs/ecs_billboards_filter.c");
    nob_da_append(&sources, "src/game/ecs/systems/ecs_gravity_gun.c");
    nob_da_append(&sources, "src/game/ecs/components/ecs_component_doors.c");
    nob_da_append(&sources, "src/game/ecs/systems/ecs_door_systems.c");
    ...
    nob_da_append(&sources, "src/engine/prefab/loading/pf_loading.c");
    nob_da_append(&sources, "src/engine/prefab/registry/pf_registry.c");
    nob_da_append(&sources, "src/engine/prefab/components/pf_component_helpers.c");
    nob_da_append(&sources, "tests/unit/ecs/pf_loading/pf_loading_stubs.c");
    nob_da_append(&sources, "tests/unit/ecs/pf_loading/test_pf_loading.c");
    ...
    for (size_t i = 0; i < sources.count; ++i) {
        ...
        const char *obj = nob_temp_sprintf("build/tests/obj/pf_loading/%s.o", stem);
    ...
    Nob_Cmd cmd = {0};
    {
        ...
        nob_sb_append_cstr(&link, "-o build/tests/plugins/tests_pf_loading.so -lm");
