...
void test_systems_registration_orders_and_hooks(void)
{
    ...
    TEST_ASSERT_TRUE(g_ecs_liftable_hooks_seq < g_systems_init_seq);
    ...
    assert_registration(16, PHASE_SIM_POST, 250, "grav_gun_fx");
    assert_registration(17, PHASE_SIM_POST, 400, "doors_tick");
    assert_registration(18, PHASE_SIM_POST, 900, "world_apply_edits");
    assert_registration(19, PHASE_PRESENT, 10, "toast_update");
    assert_registration(20, PHASE_PRESENT, 20, "camera_tick");
    assert_registration(21, PHASE_PRESENT, 100, "sprite_anim");
    assert_registration(22, PHASE_RENDER, 10, "render_begin");
    assert_registration(23, PHASE_RENDER, 20, "render_world_prepare");
    assert_registration(24, PHASE_RENDER, 30, "render_world_base");
    assert_registration(25, PHASE_RENDER, 40, "render_world_fx");
    assert_registration(26, PHASE_RENDER, 50, "render_world_sprites");
    assert_registration(27, PHASE_RENDER, 60, "render_world_overlays");
    assert_registration(28, PHASE_RENDER, 70, "render_world_end");
    assert_registration(29, PHASE_RENDER, 80, "render_ui");
    assert_registration(30, PHASE_RENDER, 90, "render_end");
    assert_registration(31, PHASE_RENDER, 1000, "asset_collect");
}
